...
type ChangePasswordParams struct {
	...
	*/
	Request *models.APIChangePasswordRequest
...
// WithRequest adds the request to the change password params
func (o *ChangePasswordParams) WithRequest(request *models.APIChangePasswordRequest) *ChangePasswordParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the change password params
func (o *ChangePasswordParams) SetRequest(request *models.APIChangePasswordRequest) {
	o.Request = request
}
