...
// WithRefreshToken adds the refreshToken to the refresh token params
func (o *RefreshTokenParams) WithRefreshToken(refreshToken RefreshTokenBody) *RefreshTokenParams {
	o.SetRefreshToken(refreshToken)
	return o
}

// SetRefreshToken adds the refreshToken to the refresh token params
func (o *RefreshTokenParams) SetRefreshToken(refreshToken RefreshTokenBody) {
