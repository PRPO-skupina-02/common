...
type LoginParams struct {
	...
	/* Request.
	   ...
	   Login credentials
	*/
	Request *models.APILoginRequest
...
func (o *LoginParams) WithRequest(request *models.APILoginRequest) *LoginParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the login params
func (o *LoginParams) SetRequest(request *models.APILoginRequest) {
	o.Request = request
}
