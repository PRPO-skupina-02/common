...
type UpdateCurrentUserParams struct {
	...
	/* Request.
	   ...
	   User update details
	*/
	Request *models.APIUpdateUserRequest
...
// WithRequest adds the request to the update current user params
func (o *UpdateCurrentUserParams) WithRequest(request *models.APIUpdateUserRequest) *UpdateCurrentUserParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the update current user params
func (o *UpdateCurrentUserParams) SetRequest(request *models.APIUpdateUserRequest) {
	o.Request = request
}
