...
type RegisterParams struct {
	...
	*/
	Request *models.APIRegisterRequest
...
// WithRequest adds the request to the register params
func (o *RegisterParams) WithRequest(request *models.APIRegisterRequest) *RegisterParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the register params
func (o *RegisterParams) SetRequest(request *models.APIRegisterRequest) {
	o.Request = request
}
