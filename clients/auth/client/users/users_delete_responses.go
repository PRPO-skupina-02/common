...
func (o *UsersDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /users/{userID}] UsersDelete", response, response.Code())
	}
}
...
func (o *UsersDeleteNoContent) Error() string {
	return fmt.Sprintf("[DELETE /users/{userID}][%d] usersDeleteNoContent", 204)
}
...
func (o *UsersDeleteBadRequest) Error() string {
	...
	return fmt.Sprintf("[DELETE /users/{userID}][%d] usersDeleteBadRequest %s", 400, payload)
}
...
func (o *UsersDeleteBadRequest) GetPayload() *models.MiddlewareHTTPError {
	return o.Payload
}
...
func (o *UsersDeleteUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /users/{userID}][%d] usersDeleteUnauthorized %s", 401, payload)
}
...
func (o *UsersDeleteUnauthorized) GetPayload() *models.MiddlewareHTTPError {
	return o.Payload
}
...
func (o *UsersDeleteNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /users/{userID}][%d] usersDeleteNotFound %s", 404, payload)
}
...
func (o *UsersDeleteNotFound) GetPayload() *models.MiddlewareHTTPError {
	return o.Payload
}
...
func (o *UsersDeleteInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /users/{userID}][%d] usersDeleteInternalServerError %s", 500, payload)
}
...
func (o *UsersDeleteInternalServerError) GetPayload() *models.MiddlewareHTTPError {
	return o.Payload
}
