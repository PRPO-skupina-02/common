...
// WithUserID adds the userID to the users delete params
func (o *UsersDeleteParams) WithUserID(userID string) *UsersDeleteParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the users delete params
func (o *UsersDeleteParams) SetUserID(userID string) {
	o.UserID = userID
}
