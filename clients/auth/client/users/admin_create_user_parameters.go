...
type AdminCreateUserParams struct {
	...
	*/
	Request *models.APIAdminCreateUserRequest
...
// WithRequest adds the request to the admin create user params
func (o *AdminCreateUserParams) WithRequest(request *models.APIAdminCreateUserRequest) *AdminCreateUserParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the admin create user params
func (o *AdminCreateUserParams) SetRequest(request *models.APIAdminCreateUserRequest) {
	o.Request = request
}
